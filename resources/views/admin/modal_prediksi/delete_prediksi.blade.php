<div class="modal fade" id="deletePrediksi_{{ $item->kode_pertanian }}" tabindex="-1" aria-labelledby="addModalLabel" aria-hidden="true">
    <form action="" method="post" id="deletePrediksiForm" class="formDeletePrediksi">
        @csrf
