<div class="modal fade" id="updatepertanianAnggota_{{ $pertanian->kode_pertanian }}" tabindex="-1" aria-labelledby="addModalLabel" aria-hidden="true">
    <form action="" method="post" id="updatePertanianAnggotaForm" class="formUpdatePertanianAnggota">
        @csrf
