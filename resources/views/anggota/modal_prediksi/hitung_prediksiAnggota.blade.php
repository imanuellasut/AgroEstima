<div class="modal fade" id="hitungPrediksiAggota_{{ $item->kode_pertanian }}" tabindex="-1" aria-labelledby="addModalLabel" aria-hidden="true">
    <form action="{{ route('hitung_prediks_anggota') }}" method="post" id="hitungPrediksiForm" class="formHitungPrediksi">
        @csrf
